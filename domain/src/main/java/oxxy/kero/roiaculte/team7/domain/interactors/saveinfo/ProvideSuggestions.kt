...
class ProvideSuggestions @Inject constructor(dispatchers: CouroutineDispatchers, val repo :SearchRepository)   :
    EitherInteractor<String, List<Suggestions>, Failure.ProvideSuggestionFaillure> {
