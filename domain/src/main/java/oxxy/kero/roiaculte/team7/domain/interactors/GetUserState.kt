...
class GetUserState @Inject constructor(val repo :AuthentificationRepository, dispatchers :CouroutineDispatchers):
EitherInteractor<None , UserState, Failure.ProvideUserStateFailure>{
