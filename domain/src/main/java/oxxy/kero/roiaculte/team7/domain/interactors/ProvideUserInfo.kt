...
class ProvideUserInfo  @Inject constructor(val repo :AuthentificationRepository, dispatchers: CouroutineDispatchers) :EitherInteractor<None ,UserInfo , Failure.NoUserInfo> {
