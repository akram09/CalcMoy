package oxxy.kero.roiaculte.team7.domain.interactors.events
...
class UpdateEvent @Inject constructor(dispatchers: CouroutineDispatchers ,val repo :MainRepository)
    :
    ...
    override suspend fun invoke(executeParams: Event): Either<Failure.DataBaseError, None> {
        return  repo.updateEvent(executeParams)
    }
}