...
class LoginUseCase @Inject constructor(val repo :AuthentificationRepository, dispatchers: CouroutineDispatchers) : EitherInteractor<LoginParam, None, Failure.LoginFailure> {
